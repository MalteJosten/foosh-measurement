...
\dirtree{%
    .1 .
    .2 Summary/Astract (\textit{actually needed?}).
    .2 Introduction.
    .2 Background (current SmartHome technologies etc.).
    .2 Previous/Related Work.
    .2 Design.
    .3 What is the goal? How does it look (general architecture).
    .2 Implementation.
    ...
    .3 Discussion of (general) outcomes and findings.
